...
# state size - site_A, remained_duration, remained_A, remained_B, next state 1,2,3
# inventory A, inventory B 6
...
class A2CAgent:
    def __init__(self, state_size, action_size):
        ...
        if self.load_model:
            self.actor.load_weights("sample_model/actor_trained.h5")
            self.critic.load_weights("sample_model/critic_trained.h5")
